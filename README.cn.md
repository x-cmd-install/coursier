...
![coursier](https://repo.x-cmd.io/coursier.svg?lang=zh)
...
合计: **112,167** 行代码（覆盖前 5 种语言、共 **856** 个文件）。
...
- **官网**: <https://get-coursier.io>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `nightly` (2026-08-03)
- **最近提交**: 2026-09-10
- **Release 含资产**: 13 个

## 流行度

- **Star**: 2,135 · **Fork**: 334 · **开放 issue**: 1,202 · **贡献者**: 158

## 累计统计

- **发布数**: 209 · **已合并 PR**: 2056 · **开放 PR**: 61 · **已关闭 issue**: 812 · **开放 issue**: 390 · **提交数**: 5449

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-11 | 0 | 65 | 2 | 0 | 1 | 91 |
| last60d | 2026-07-12 | 1 | 90 | 5 | 1 | 4 | 133 |
| 90d | 2026-06-12 | 2 | 108 | 7 | 1 | 8 | 164 |
| last180d | 2026-03-14 | 3 | 201 | 20 | 6 | 13 | 304 |
| 360d | 2025-09-15 | 9 | 241 | 24 | 24 | 16 | 371 |
| last720d | 2024-09-20 | 38 | 516 | 43 | 65 | 40 | 1072 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/coursier.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260910.yml` · 2026-09-10T22:20:26Z._
